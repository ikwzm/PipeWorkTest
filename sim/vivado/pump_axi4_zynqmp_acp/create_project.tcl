...
set test_bench              "PUMP_AXI4_TO_AXI4_TEST_BENCH_ZYNQMP_ACP"
set scenario_file           [file join $project_directory ".." ".." ".." "src" "test" "scenarios" "pump_axi4" "pump_axi4_to_axi4_test_bench_zynqmp_acp.snr" ]
##
# Create project
#
...
set_property "generic" "SCENARIO_FILE=$scenario_full_path" $obj

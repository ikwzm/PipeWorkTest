...
set project_name            "unrolled_loop_counter"
...
set_property "top" "UNROLLED_LOOP_COUNTER"  $obj
#
# Set 'sim_1' fileset properties
#
set obj [get_filesets sim_1]
set_property "top" "UNROLLED_LOOP_COUNTER_TEST_BENCH_32_0_1_2"  $obj
set_property "generic" "FINISH_ABORT=true" $obj

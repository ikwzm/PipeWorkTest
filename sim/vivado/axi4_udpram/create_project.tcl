...
if {![info exists project_name]} {
    set test_bench        "AXI4_UDPRAM_64x32_R4W4RF_TEST_BENCH"
}
foreach arg $argv {
    if {[string match "test_bench=*" $arg]} {
        set test_bench [string range $arg [string length "test_bench="] end]
    }
}
set project_directory       [file dirname [info script]]
set project_name            [string tolower $test_bench]
set device_parts            "xc7z010clg400-1"
set scenario_path           [file join ".." ".." ".." "src" "test" "scenarios" "axi4_udpram" ]
set scenario_file           [file join $scenario_path "[string tolower $test_bench].snr"]
#
# Create project
#
...
set_property "top" "AXI4_UDPRAM" $obj
#
